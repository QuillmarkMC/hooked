...
execute at @e[type=marker,tag=redShop,limit=1] run summon text_display ~ ~1.5 ~ {text:{"translate":"text.game.shop.floating_text","color":"green"},alignment:"center", billboard:"vertical",Tags:["shopName","gameMarker"]}
...
execute at @e[type=marker,tag=blueShop,limit=1] run summon text_display ~ ~1.5 ~ {text:{"translate":"text.game.shop.floating_text","color":"green"},alignment:"center", billboard:"vertical",Tags:["shopName","gameMarker"]}
