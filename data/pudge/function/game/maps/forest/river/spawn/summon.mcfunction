...
#gold
execute if score $out rng matches 1..4 positioned ~ ~ ~ rotated ~ ~ run summon armor_stand ~ ~ ~ {Marker:true,Invisible:true,Passengers:[{id:"item",Item:{id:"gold_ingot",count:1b},Glowing:true,Age:-32768s,PickupDelay:32767,Tags:["riverPower"],Invulnerable:true},{id:"slime",Size:0,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0b,show_particles:false},{id:"minecraft:resistance",duration:-1,amplifier:10b,show_particles:false}],Silent:1b,Tags:["riverPower","goldPower","tempSlimeFixTag"],NoAI:1b,attributes:[{base:2.0d,id:"minecraft:scale"}],Passengers:[{id:"text_display",text:{"translate":"text.game.river.gold.name","color": "gold","bold": true},alignment:"center",billboard:"vertical",background:0,Tags:["riverPower"]}]}],Tags:["riverAEC","riverPower"]}
...
#insta hook
execute if score $out rng matches 5..8 positioned ~ ~ ~ rotated ~ ~ run summon armor_stand ~ ~ ~ {Marker:true,Invisible:true,Passengers:[{id:"item",Item:{id:"crossbow",count:1b},Glowing:true,Age:-32768s,PickupDelay:32767,Tags:["riverPower"],Invulnerable:true},{id:"slime",Size:0,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0b,show_particles:false},{id:"minecraft:resistance",duration:-1,amplifier:10b,show_particles:false}],Silent:1b,Tags:["riverPower","hookPower","tempSlimeFixTag"],NoAI:1b,attributes:[{base:2.0d,id:"minecraft:scale"}],Passengers:[{id:"text_display",text:{"translate":"text.game.river.hook.name","color": "white","bold": true},alignment:"center",billboard:"vertical",background:0,Tags:["riverPower"]}]}],Tags:["riverAEC","riverPower"]}
...
#suicide
execute if score $out rng matches 13..16 positioned ~ ~ ~ rotated ~ ~ run summon armor_stand ~ ~ ~ {Marker:true,Invisible:true,Passengers:[{id:"item",Item:{id:"tnt",count:1b},Glowing:true,Age:-32768s,PickupDelay:32767,Tags:["riverPower"],Invulnerable:true},{id:"slime",Size:0,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0b,show_particles:false},{id:"minecraft:resistance",duration:-1,amplifier:10b,show_particles:false}],Silent:1b,Tags:["riverPower","suicidePower","tempSlimeFixTag"],NoAI:1b,attributes:[{base:2.0d,id:"minecraft:scale"}],Passengers:[{id:"text_display",text:{"translate":"text.game.river.suicide.name","color": "dark_gray","bold": true},alignment:"center",billboard:"vertical",background:0,Tags:["riverPower"]}]}],Tags:["riverAEC","riverPower"]}
...
#rapid fire
execute if score $out rng matches 17..20 positioned ~ ~ ~ rotated ~ ~ run summon armor_stand ~ ~ ~ {Marker:true,Invisible:true,Passengers:[{id:"item",Item:{id:"arrow",count:1b},Glowing:true,Age:-32768s,PickupDelay:32767,Tags:["riverPower"],Invulnerable:true},{id:"slime",Size:0,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0b,show_particles:false},{id:"minecraft:resistance",duration:-1,amplifier:10b,show_particles:false}],Silent:1b,Tags:["riverPower","rapidFirePower","tempSlimeFixTag"],NoAI:1b,attributes:[{base:2.0d,id:"minecraft:scale"}],Passengers:[{id:"text_display",text:{"translate":"text.game.river.rapid_fire.name","color": "blue","bold": true},alignment:"center",billboard:"vertical",background:0,Tags:["riverPower"]}]}],Tags:["riverAEC","riverPower"]}
...
#adrenaline
execute if score $out rng matches 21..24 positioned ~ ~ ~ rotated ~ ~ run summon armor_stand ~ ~ ~ {Marker:true,Invisible:true,Passengers:[{id:"item",Item:{id:"bedrock",count:1b,components:{item_model:"pudge:river/lightning"}},Glowing:true,Age:-32768s,PickupDelay:32767,Tags:["riverPower"],Invulnerable:true},{id:"slime",Size:0,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0b,show_particles:false},{id:"minecraft:resistance",duration:-1,amplifier:10b,show_particles:false}],Silent:1b,Tags:["riverPower","adrenalinePower","tempSlimeFixTag"],NoAI:1b,attributes:[{base:2.0d,id:"minecraft:scale"}],Passengers:[{id:"text_display",text:{"translate":"text.game.river.adrenaline.name","color": "yellow","bold": true},alignment:"center",billboard:"vertical",background:0,Tags:["riverPower"]}]}],Tags:["riverAEC","riverPower"]}
