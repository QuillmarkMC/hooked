...
execute if score $out rng = $LastPlayed9 music unless score #Temp music matches 1.. run function pudge:game/music/playlist/minecraft/generate
execute if score $out rng = $LastPlayed10 music unless score #Temp music matches 1.. run function pudge:game/music/playlist/minecraft/generate
