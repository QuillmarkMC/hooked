...
item replace entity @s enderchest.11 with bedrock[custom_name={"translate":"text.game.shop.navigation.stat.name","color":"light_purple","bold":true,"italic":false},lore=[{"translate":"text.game.shop.navigation.stat.tooltip","color":"gray","italic":false}],item_model=book,custom_data={Stats:1b,Shop:1b}]
item replace entity @s enderchest.12 with air
item replace entity @s enderchest.13 with bedrock[custom_name={"translate":"text.game.shop.navigation.ability.name","color":"aqua","bold":true,"italic":false},lore=[{"translate":"text.game.shop.navigation.ability.tooltip.1","color":"gray","italic":false},{"translate":"text.game.shop.navigation.ability.tooltip.2","color":"gray","italic":false}],item_model=sculk,custom_data={Abilities:1b,Shop:1b}]
item replace entity @s enderchest.14 with air
item replace entity @s enderchest.15 with bedrock[custom_name={"translate":"text.game.shop.navigation.consume.name","color":"green","bold":true,"italic":false},lore=[{"translate":"text.game.shop.navigation.consume.tooltip.1","color":"gray","italic":false},{"translate":"text.game.shop.navigation.consume.tooltip.2","color":"gray","italic":false}],item_model=golden_apple,custom_data={Consumes:1b,Shop:1b}]
