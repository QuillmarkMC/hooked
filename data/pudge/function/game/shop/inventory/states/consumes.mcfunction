...
item replace entity @s enderchest.26 with bedrock[custom_name={"translate":"text.game.shop.navigation.back.name","color":"dark_red","bold":true,"italic":false},lore=[{"translate":"text.game.shop.navigation.back.tooltip","color":"gray","italic":false}],item_model=barrier,custom_data={BackPage:1b,Shop:1b},tooltip_display={hide_tooltip:true}]
