...
summon armor_stand 55 57 52 {Tags:["outroCutscene","outroCam2"],Marker:1b,Invisible:true,Silent:true,Rotation:[180.0f,5.0f]}
...
#start camera 1
function pudge:game/postgame/forest/cutscene/camera1/begin