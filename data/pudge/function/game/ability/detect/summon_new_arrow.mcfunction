...
#execute rotated as @s run rotate @e[type=arrow,tag=tempArrowTag,sort=nearest,limit=1] ~ ~
...
execute unless score @s entityid matches 0.. run function entity_hit_matching:assign_id
...
#set arrow owner
scoreboard players operation @s arrowOwner = $Temp arrowOwner
