...
execute if data entity @e[type=snowball,sort=nearest,limit=1] Item.components.minecraft:custom_data.CreeperSnowball run scoreboard players operation @s cdCreeper = @s cdCreeperCurrent
