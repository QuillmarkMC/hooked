...
#chest
execute unless score @s elytraTimer matches 1.. if entity @s[team=red] run item replace entity @s armor.chest with leather_chestplate[unbreakable={},attribute_modifiers=[{id:"armor",type:"armor",amount:0,operation:"add_value"}],dyed_color=16725044,tooltip_display={hidden_components:["unbreakable","dyed_color","attribute_modifiers"]}]
execute unless score @s elytraTimer matches 1.. if entity @s[team=blue] run item replace entity @s armor.chest with leather_chestplate[unbreakable={},attribute_modifiers=[{id:"armor",type:"armor",amount:0,operation:"add_value"}],dyed_color=3618047,tooltip_display={hidden_components:["unbreakable","dyed_color","attribute_modifiers"]}]
execute if score @s elytraTimer matches 1.. run item replace entity @s armor.chest with elytra[unbreakable={},attribute_modifiers=[{id:"armor",type:"armor",amount:0,operation:"add_value"}],custom_name={"translate":"text.game.inventory.elytra","color":"light_purple","bold":true,"italic":false},tooltip_display={hidden_components:["unbreakable","attribute_modifiers"]}]
#legs
...
execute if entity @s[tag=!hasHook] run item replace entity @s hotbar.0 with barrier[custom_name={"translate":"text.game.inventory.unavailable.name","color":"dark_red","bold":true,"italic":false},lore=[{"translate":"text.game.inventory.unavailable.lore","color":"gray","italic":false}],item_model="pudge:general/hidden"]
#hotbar 1
execute if entity @s[tag=hasMelee] run function pudge:game/inventory/items/melee/give
execute if entity @s[tag=!hasMelee] run item replace entity @s hotbar.1 with barrier[custom_name={"translate":"text.game.inventory.unavailable.name","color":"dark_red","bold":true,"italic":false},lore=[{"translate":"text.game.inventory.unavailable.lore","color":"gray","italic":false}],item_model="pudge:general/hidden"]
#hotbar 2
...
execute if score $MaxInventoryUpgrades var matches 1.. if score @s hotbar.2.ID matches ..0 run item replace entity @s hotbar.2 with barrier[custom_name={"translate":"text.game.inventory.empty.name","color":"dark_red","bold":true,"italic":false},lore=[{"translate":"text.game.inventory.empty.lore","color":"gray","italic":true}],item_model="pudge:general/hidden"]
