execute if score @s cdTotem matches ..0 run item replace entity @s hotbar.6 with bedrock[custom_model_data=105]
execute if score @s cdTotem matches 1.. run item replace entity @s hotbar.6 with shears[custom_model_data=105]
