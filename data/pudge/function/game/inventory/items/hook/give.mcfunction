...
execute if entity @s[scores={cdHook=1..}] run item replace entity @s hotbar.0 with shears[custom_name='{"translate":"text.game.inventory.hook.name","color":"gray","bold":true,"italic":false}',lore=['{"text":" "}'],item_model="crossbow",custom_data={Cooldown:1},hide_additional_tooltip={}]
