execute unless entity @s[tag=PreventGrapple] if score @s cdGrapple matches ..0 run item replace entity @s hotbar.3 with crossbow[unbreakable={},item_model="pudge:ability/grapple_loaded",custom_data={Grapple:1},tooltip_display={hidden_components:["unbreakable","charged_projectiles"]},charged_projectiles=[{id:"minecraft:arrow",count:1}]]
execute if score @s cdGrapple matches 1.. run item replace entity @s hotbar.3 with shears[item_model="pudge:ability/grapple_unloaded"]
execute if entity @s[tag=PreventGrapple] if score @s cdGrapple matches ..0 run item replace entity @s hotbar.3 with shears[unbreakable={},item_model="pudge:ability/grapple_unloaded",tooltip_display={hidden_components:["unbreakable"]}]
