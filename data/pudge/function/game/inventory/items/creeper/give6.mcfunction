execute if score @s cdCreeper matches ..0 run item replace entity @s hotbar.6 with snowball[custom_model_data=100,custom_data={CreeperSnowball:1b,CustomSnowball:1b}]
execute if score @s cdCreeper matches 1.. run item replace entity @s hotbar.6 with shears[custom_model_data=100]
