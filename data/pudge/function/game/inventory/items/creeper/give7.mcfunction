execute if score @s cdCreeper matches ..0 run item replace entity @s hotbar.7 with snowball[item_model="pudge:ability/creeper",custom_data={CreeperSnowball:1b,CustomSnowball:1b}]
execute if score @s cdCreeper matches 1.. run item replace entity @s hotbar.7 with shears[item_model="pudge:ability/creeper"]
