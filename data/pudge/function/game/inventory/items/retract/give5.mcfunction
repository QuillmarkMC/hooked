item replace entity @s hotbar.5 with bedrock[item_model="iron_chain"]

#dynamic item lore
item modify entity @s hotbar.5 pudge:lore/retract/retract_name
item modify entity @s hotbar.5 pudge:lore/retract/retract_tooltip
...
item modify entity @s hotbar.5 pudge:lore/retract/retract_speed