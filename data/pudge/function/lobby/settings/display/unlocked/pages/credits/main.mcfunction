...
setblock 202 66 -66 oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"blue",messages:['""', '{"translate":"text.lobby.settings.signs.credits.title.1","color":"dark_green"}', '{"translate":"text.lobby.settings.signs.credits.title.2","color":"white"}', '""']}}
...
setblock 200 64 -66 oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"white",messages:['{"text":"Strongis13","color":"aqua"}', '{"translate":"text.lobby.settings.signs.credits.strongis13.role","color":"white"}', '""', '""']}}
...
setblock 204 64 -66 oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"white",messages:['{"text":"Soccby","color":"aqua"}', '{"translate":"text.lobby.settings.signs.credits.soccby.role","color":"white"}', '""', '""']}}
