setblock 202 64 -66 oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,messages:['{"clickEvent":{"action":"run_command","value": "/trigger lobbysigns set 207"},"text": ""}', '{"translate":"text.lobby.settings.signs.gameplay.forest","color":"white"}', '""', '""']}}
