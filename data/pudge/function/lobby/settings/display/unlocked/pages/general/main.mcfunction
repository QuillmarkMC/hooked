...
setblock 202 66 -66 oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"blue",messages:['""', '{"text":"Page 1","color":"dark_green"}', '{"text":"General","color":"white"}', '""']}}
...
setblock 202 65 -66 oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"blue",messages:['{"clickEvent":{"action":"run_command","value": "trigger lobbysigns set 1"},"text": ""}', '{"text":"Start Game","color":"dark_green"}', '[{"text":"[","color": "white"},{"keybind":"key.use","color":"white"},{"text":"]","color": "white"}]', '""']}}
...
setblock 201 64 -66 oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"red",messages:['{"clickEvent":{"action":"run_command","value": "trigger lobbysigns set 103"},"text": ""}', '{"text":"Reset to","color":"white"}', '{"text":"Default","color":"red"}', '""']}}
#setblock 202 64 -66 air
setblock 203 64 -66 dark_oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"blue",messages:['{"clickEvent":{"action":"run_command","value": "trigger lobbysigns set 106"},"text": ""}', '{"text":"Lock Settings","color":"yellow"}', '{"text":"[Admins Only]","color":"white"}', '""']}}
