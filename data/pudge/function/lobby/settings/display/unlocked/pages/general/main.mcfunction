...
setblock 202 66 -66 oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"blue",messages:[{"text":""}, {"translate":"text.lobby.settings.signs.general.title.1","color":"dark_green"}, {"translate":"text.lobby.settings.signs.general.title.2","color":"white"}, {"text":""}]}}
...
setblock 202 65 -66 oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"blue",messages:[{"click_event":{"action":"run_command","command": "/trigger lobbysigns set 1"},"text": ""}, {"translate":"text.lobby.settings.signs.general.start","color":"dark_green"}, [{"text":"[","color": "white"},{"keybind":"key.use","color":"white"},{"text":"]","color": "white"}], {"text":""}]}}
...
setblock 201 64 -66 oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"red",messages:[{"click_event":{"action":"run_command","command": "/trigger lobbysigns set 103"},"text": ""}, {"translate":"text.lobby.settings.signs.general.reset.1","color":"white"}, {"translate":"text.lobby.settings.signs.general.reset.2","color":"red"}, {"text":""}]}}
#setblock 202 64 -66 air
setblock 203 64 -66 dark_oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"blue",messages:[{"click_event":{"action":"run_command","command": "/trigger lobbysigns set 106"},"text": ""}, {"translate":"text.lobby.settings.signs.general.lock","color":"yellow"}, {"translate":"text.lobby.settings.signs.general.lock.admin","color":"white"}, {"text":""}]}}
