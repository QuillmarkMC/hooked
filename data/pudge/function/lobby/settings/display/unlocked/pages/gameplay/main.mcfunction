...
setblock 202 66 -66 oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"blue",messages:['""', '{"translate":"text.lobby.settings.signs.gameplay.title.1","color":"dark_green"}', '{"translate":"text.lobby.settings.signs.gameplay.title.2","color":"white"}', '{"text":"","color":"white"}']}}
