...
setblock 202 66 -66 dark_oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"blue",messages:[{"text":""}, {"translate":"text.lobby.settings.signs.shop1.title.1","color":"dark_green"}, {"translate":"text.lobby.settings.signs.shop1.title.2","color":"white"}, {"text":""}]}}
...
function pudge:lobby/settings/display/locked/pages/shop1/hook_cd
function pudge:lobby/settings/display/locked/pages/shop1/hook_damage
function pudge:lobby/settings/display/locked/pages/shop1/bounce
function pudge:lobby/settings/display/locked/pages/shop1/melee_damage
function pudge:lobby/settings/display/locked/pages/shop1/extra_health
#setblock 205 65 -66 air
#3rd row
#setblock 199 64 -66 air
#setblock 200 64 -66 air
function pudge:lobby/settings/display/locked/pages/shop1/heal
function pudge:lobby/settings/display/locked/pages/shop1/haste
function pudge:lobby/settings/display/locked/pages/shop1/ranged_ap
