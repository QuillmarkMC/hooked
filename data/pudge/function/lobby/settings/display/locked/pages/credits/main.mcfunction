...
setblock 202 66 -66 dark_oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"blue",messages:[{"text":""}, {"translate":"text.lobby.settings.signs.credits.title.1","color":"dark_green"}, {"translate":"text.lobby.settings.signs.credits.title.2","color":"white"}, {"text":""}]}}
...
setblock 200 64 -66 dark_oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"white",messages:[{"text":"Strongis13","color":"aqua"}, {"translate":"text.lobby.settings.signs.credits.strongis13.role","color":"white"}, {"text":""}, {"text":""}]}}
...
setblock 204 64 -66 dark_oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"white",messages:[{"text":"Soccby","color":"aqua"}, {"translate":"text.lobby.settings.signs.credits.soccby.role","color":"white"}, {"text":""}, {"text":""}]}}
