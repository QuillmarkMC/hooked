...
execute at @e[type=villager,tag=blueTeamSelect,limit=1] run summon minecraft:armor_stand ~ ~2 ~ {Invisible:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,CustomName:"{\"translate\":\"text.lobby.teams.npc.blue\",\"color\":\"blue\"}",CustomNameVisible:1b,Tags:["teamSelect"]}
#red
...
execute at @e[type=villager,tag=redTeamSelect,limit=1] run summon minecraft:armor_stand ~ ~2 ~ {Invisible:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,CustomName:"{\"translate\":\"text.lobby.teams.npc.red\",\"color\":\"red\"}",CustomNameVisible:1b,Tags:["teamSelect"]}
#random
...
execute at @e[type=villager,tag=randomTeamSelect,limit=1] run summon minecraft:armor_stand ~ ~2 ~ {Invisible:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,CustomName:"{\"translate\":\"text.lobby.teams.npc.random\",\"color\":\"light_purple\"}",CustomNameVisible:1b,Tags:["teamSelect"]}
