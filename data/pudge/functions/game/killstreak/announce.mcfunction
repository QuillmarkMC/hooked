...
execute if score $Temp killstreak matches 1 as @a at @s run playsound pudge:game.double_kill ambient @s ~ ~ ~
...
execute if score $Temp killstreak matches 2 as @a at @s run playsound pudge:game.triple_kill ambient @s ~ ~ ~
...
execute if score $Temp killstreak matches 3 as @a at @s run playsound pudge:game.ultrakill ambient @s ~ ~ ~
...
execute if score $Temp killstreak matches 4 as @a at @s run playsound pudge:game.rampage ambient @s ~ ~ ~
...
execute if score $Temp killstreak matches 5 as @a at @s run playsound pudge:game.combowhore ambient @s ~ ~ ~
...
execute if score $Temp killstreak matches 10 as @a at @s run playsound pudge:game.killing_spree ambient @s ~ ~ ~
...
execute if score $Temp killstreak matches 11 as @a at @s run playsound pudge:game.dominating ambient @s ~ ~ ~
...
execute if score $Temp killstreak matches 12 as @a at @s run playsound pudge:game.megakill ambient @s ~ ~ ~
...
execute if score $Temp killstreak matches 13 as @a at @s run playsound pudge:game.unstoppable ambient @s ~ ~ ~
...
execute if score $Temp killstreak matches 14 as @a at @s run playsound pudge:game.whickedsick ambient @s ~ ~ ~
...
execute if score $Temp killstreak matches 15 as @a at @s run playsound pudge:game.monster_kill ambient @s ~ ~ ~
...
execute if score $Temp killstreak matches 16 as @a at @s run playsound pudge:game.godlike ambient @s ~ ~ ~
...
execute if score $Temp killstreak matches 100 as @a at @s run playsound pudge:game.firstblood ambient @s ~ ~ ~
...
execute if score $Temp killstreak matches 17 as @a at @s run playsound pudge:game.ownage ambient @s ~ ~ ~
