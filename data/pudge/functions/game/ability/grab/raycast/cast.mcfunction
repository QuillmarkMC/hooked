...
execute if score $Debug var matches 1.. run say game/ability/grab/raycast/cast

execute if score $Hit raycast matches 0 positioned ~-0.05 ~-0.05 ~-0.05 as @a[tag=!raycasting,dx=0,sort=nearest] run function pudge:game/ability/grab/raycast/check
