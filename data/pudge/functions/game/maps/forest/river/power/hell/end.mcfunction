...
execute if score #Temp3 river matches 1 run tellraw @a [{"text": "[!] ","color": "yellow","bold": true},{"text":"","extra":[{"selector":"@a[tag=hellWinner]"}],"bold": false},{"text": " survived the Deathmatch and was awarded ","color": "white","bold": false},{"score":{"name":"#Temp","objective":"gold"},"color": "gold"},{"text": " gold!","color": "gold","bold": false}]
execute if score #Temp3 river matches 2.. run tellraw @a [{"text": "[!] ","color": "yellow","bold": true},{"text":"","extra":[{"selector":"@a[tag=hellWinner]"}],"bold": false},{"text": " survived the Deathmatch together and were each awarded ","color": "white","bold": false},{"score":{"name":"#Temp","objective":"gold"},"color": "gold"},{"text": " gold!","color": "gold","bold": false}]
