...
#hell
execute if score $out rng matches 0 positioned ~ ~ ~ rotated ~ ~ run summon armor_stand ~ ~ ~ {Marker:1,Invisible:1,Passengers:[{id:"item",Item:{id:"blaze_powder",Count:1b},Glowing:1,Age:-32768s,PickupDelay:32767,Tags:["riverPower"],Invulnerable:true},{id:"slime",Size:1,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0b,show_particles:false},{id:"minecraft:resistance",duration:-1,amplifier:10b,show_particles:false}],Silent:1b,Tags:["riverPower","hellPower","tempSlimeFixTag"],NoAI:1b},{id:"text_display",text:'[{"text":"Deathmatch\\n\\n\\n\\n","color": "dark_red","bold": true}]',alignment:"center",billboard:"vertical",background:0,see_through:true,shadow:true,Tags:["riverPower"]}],Tags:["riverAEC","riverPower"]}
...
#gold
execute if score $out rng matches 1..4 positioned ~ ~ ~ rotated ~ ~ run summon armor_stand ~ ~ ~ {Marker:1,Invisible:1,Passengers:[{id:"item",Item:{id:"gold_ingot",Count:1b},Glowing:1,Age:-32768s,PickupDelay:32767,Tags:["riverPower"],Invulnerable:true},{id:"slime",Size:1,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0b,show_particles:false},{id:"minecraft:resistance",duration:-1,amplifier:10b,show_particles:false}],Silent:1b,Tags:["riverPower","goldPower","tempSlimeFixTag"],NoAI:1b},{id:"text_display",text:'[{"text":"Instant Gold\\n\\n\\n\\n","color": "gold","bold": true}]',alignment:"center",billboard:"vertical",background:0,see_through:true,shadow:true,Tags:["riverPower"]}],Tags:["riverAEC","riverPower"]}
...
#insta hook
execute if score $out rng matches 5..8 positioned ~ ~ ~ rotated ~ ~ run summon armor_stand ~ ~ ~ {Marker:1,Invisible:1,Passengers:[{id:"item",Item:{id:"crossbow",Count:1b},Glowing:1,Age:-32768s,PickupDelay:32767,Tags:["riverPower"],Invulnerable:true},{id:"slime",Size:1,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0b,show_particles:false},{id:"minecraft:resistance",duration:-1,amplifier:10b,show_particles:false}],Silent:1b,Tags:["riverPower","hookPower","tempSlimeFixTag"],NoAI:1b},{id:"text_display",text:'[{"text":"Mass Hook\\n\\n\\n\\n","color": "white","bold": true}]',alignment:"center",billboard:"vertical",background:0,see_through:true,shadow:true,Tags:["riverPower"]}],Tags:["riverAEC","riverPower"]}
...
#suicide
execute if score $out rng matches 13..16 positioned ~ ~ ~ rotated ~ ~ run summon armor_stand ~ ~ ~ {Marker:1,Invisible:1,Passengers:[{id:"item",Item:{id:"tnt",Count:1b},Glowing:1,Age:-32768s,PickupDelay:32767,Tags:["riverPower"],Invulnerable:true},{id:"slime",Size:1,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0b,show_particles:false},{id:"minecraft:resistance",duration:-1,amplifier:10b,show_particles:false}],Silent:1b,Tags:["riverPower","suicidePower","tempSlimeFixTag"],NoAI:1b},{id:"text_display",text:'[{"text":"Self Destruct\\n\\n\\n\\n","color": "dark_gray","bold": true}]',alignment:"center",billboard:"vertical",background:0,see_through:true,shadow:true,Tags:["riverPower"]}],Tags:["riverAEC","riverPower"]}
...
#rapid fire
execute if score $out rng matches 17..20 positioned ~ ~ ~ rotated ~ ~ run summon armor_stand ~ ~ ~ {Marker:1,Invisible:1,Passengers:[{id:"item",Item:{id:"arrow",Count:1b},Glowing:1,Age:-32768s,PickupDelay:32767,Tags:["riverPower"],Invulnerable:true},{id:"slime",Size:1,active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0b,show_particles:false},{id:"minecraft:resistance",duration:-1,amplifier:10b,show_particles:false}],Silent:1b,Tags:["riverPower","rapidFirePower","tempSlimeFixTag"],NoAI:1b},{id:"text_display",text:'[{"text":"Rapid Fire\\n\\n\\n\\n","color": "blue","bold": true}]',alignment:"center",billboard:"vertical",background:0,see_through:true,shadow:true,Tags:["riverPower"]}],Tags:["riverAEC","riverPower"]}
