...
#gold
execute if score $out rng matches 1 run summon armor_stand ~ ~ ~ {Marker:1,Invisible:1,Age:-2147483648,Duration:-1,WaitTime:-2147483648,Passengers:[{id:"item",Item:{id:"gold_ingot",Count:1b},Glowing:1,Age:-32768s,PickupDelay:32767,Tags:["riverPower"]},{id:"slime",Size:1,Passengers:[{id:"armor_stand",CustomNameVisible:1b,CustomName:"{\"text\":\"Instant Gold\",\"color\": \"gold\",\"bold\": true}",Invisible:1,Marker:1,Tags:["riverPower"]}],ActiveEffects:[{Id:14,Duration:999999,Amplifier:0,ShowParticles:false},{Id:11,Duration:999999,Amplifier:10,ShowParticles:false}],Silent:1b,Tags:["riverPower","goldPower"],NoAI:1b}],Tags:["riverAEC","riverPower"]}
