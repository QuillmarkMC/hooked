execute if score @s cdCreeper matches ..0 run item replace entity @s hotbar.7 with snowball{CustomModelData:100,CreeperSnowball:1b,CustomSnowball:1b}
execute if score @s cdCreeper matches 1.. run item replace entity @s hotbar.7 with shears{CustomModelData:100}
