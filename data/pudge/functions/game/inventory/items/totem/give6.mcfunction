execute if score @s cdTotem matches ..0 run item replace entity @s hotbar.6 with bedrock{CustomModelData:105}
execute if score @s cdTotem matches 1.. run item replace entity @s hotbar.6 with shears{CustomModelData:105}
