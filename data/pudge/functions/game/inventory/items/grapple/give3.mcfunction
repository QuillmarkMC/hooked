execute if score @s cdGrapple matches ..0 run item replace entity @s hotbar.3 with crossbow{CustomModelData:2,Charged:1b,ChargedProjectiles:[{id:"minecraft:arrow",Count:1b}],HideFlags:127,Unbreakable:true,Grapple:1}
...
#dynamic item lore
item modify entity @s hotbar.3 pudge:lore/grapple/grapple_name
