...
execute if entity @s[tag=PreventGrab,tag=!holdingPlayer] if score @s cdGrab matches ..0 run item replace entity @s hotbar.3 with shears{CustomModelData:2,HideFlags:127,Unbreakable:true}
