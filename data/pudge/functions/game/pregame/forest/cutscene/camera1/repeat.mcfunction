...
execute as @e[type=marker,tag=introCam1FacingTarget,limit=1] at @s run tp ^ ^ ^0.1
execute as @e[type=armor_stand,tag=introCam1,limit=1] at @s facing entity @e[type=marker,tag=introCam1TPTarget,limit=1] feet run tp @s ^ ^ ^0.15 facing entity @e[type=marker,tag=introCam1FacingTarget,limit=1] feet
