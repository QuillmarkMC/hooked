...
execute unless data entity @s EnderItems[{Slot:0b,id:"minecraft:crossbow",tag:{HookCDStats:1}}] run function pudge:game/shop/inventory/items/stats/hook_cd
execute unless data entity @s EnderItems[{Slot:1b,id:"minecraft:crossbow",tag:{HookDamageStats:1}}] run function pudge:game/shop/inventory/items/stats/hook_damage
