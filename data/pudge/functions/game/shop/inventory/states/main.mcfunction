...
execute unless data entity @s EnderItems[{Slot:12b,id:"minecraft:book",tag:{Stats:1}}] run item replace entity @s enderchest.12 with book{Stats:1,Shop:1,display:{Name:'{"text":"Stat Upgrades","color":"light_purple","bold":true,"italic":false}',Lore:['{"text":"Upgrade your player or hook stats.","color":"gray","italic":false}']},HideFlags:127}
item replace entity @s enderchest.13 with air
execute unless data entity @s EnderItems[{Slot:14b,id:"minecraft:sculk",tag:{Abilities:1}}] run item replace entity @s enderchest.14 with sculk{Abilities:1,Shop:1,display:{Name:'{"text":"Purchase Abilities","color":"aqua","bold":true,"italic":false}',Lore:['{"text":"Get new active or passive","color":"gray","italic":false}','{"text":"abilities to use.","color":"gray","italic":false}']},HideFlags:127}
item replace entity @s enderchest.15 with air
execute unless data entity @s EnderItems[{Slot:16b,id:"minecraft:golden_apple",tag:{Consumes:1}}] run item replace entity @s enderchest.16 with golden_apple{Consumes:1,Shop:1,display:{Name:'{"text":"Consumable Items","color":"aqua","bold":true,"italic":false}',Lore:['{"text":"Purchase instant or single","color":"gray","italic":false}','{"text":"use effects.","color":"gray","italic":false}']},HideFlags:127}
