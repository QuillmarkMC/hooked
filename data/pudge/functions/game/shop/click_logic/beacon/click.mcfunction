...
execute if score #Temp gold matches 1 if score @s shopItem.Beacon matches 3.. run function pudge:game/shop/click_logic/beacon/maxed
execute if score #Temp gold matches 1 if score @s shopItem.Beacon matches 2 run function pudge:game/shop/click_logic/beacon/buy3
execute if score #Temp gold matches 1 if score @s shopItem.Beacon matches 1 run function pudge:game/shop/click_logic/beacon/buy2
execute if score #Temp gold matches 1 if score @s shopItem.Beacon matches 0 run function pudge:game/shop/click_logic/beacon/buy1
