...
execute if score #Temp gold matches 1 if score @s shopItem.Grass matches 3.. run function pudge:game/shop/click_logic/grass/maxed
execute if score #Temp gold matches 1 if score @s shopItem.Grass matches 2 run function pudge:game/shop/click_logic/grass/buy3
execute if score #Temp gold matches 1 if score @s shopItem.Grass matches 1 run function pudge:game/shop/click_logic/grass/buy2
execute if score #Temp gold matches 1 if score @s shopItem.Grass matches 0 run function pudge:game/shop/click_logic/grass/buy1
