...
scoreboard players operation $StartingGold shop = @s value
scoreboard players set $StartingGold.State lobbysigns -1
tellraw @s [{"text": ""},{"text": "[!] ","color": "blue","bold": true},{"text":"Starting gold amount set to "},{"score":{"name":"$StartingGold","objective":"shop"},"color":"dark_green","bold": true},{"text":" gold","color": "gold"},{"text":"!"}]
