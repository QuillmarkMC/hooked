...
execute if score $RangedAP.State lobbysigns matches 0 run scoreboard players set $RangedAPCost shop 25
execute if score $RangedAP.State lobbysigns matches 1 run scoreboard players set $RangedAPCost shop 20
