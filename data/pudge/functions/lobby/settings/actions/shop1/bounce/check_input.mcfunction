...
execute unless score $GameMode var matches 1 run tellraw @s [{"text": ""},{"text": "[!] ","color": "blue","bold": true},{"text":"This item's price is being controlled by the selected gamemode, and cannot be changed."}]
