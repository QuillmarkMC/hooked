...
setblock 202 66 -66 dark_oak_wall_sign[facing=south]{GlowingText:true,Color:"blue",Text1:'',Text2:'{"text":"Page 4","color":"dark_green"}',Text3:'{"text":"Shop: Part 2","color":"white"}',Text4:""}
