...
setblock 202 65 -66 dark_oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"light_gray",messages:['[{"text":"Click here ","color":"yellow"},{"text":"to","color":"white"}]', '{"text":"download the","color":"white"}', '{"text":"full map on","color":"white"}', '{"text":"Planet Minecraft!","clickEvent":{"action":"run_command","value": "trigger lobbysigns set 501"},"color": "green"}']}}
