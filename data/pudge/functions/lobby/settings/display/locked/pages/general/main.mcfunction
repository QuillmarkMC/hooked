...
setblock 202 66 -66 dark_oak_wall_sign[facing=south]{GlowingText:true,Color:"blue",Text1:'',Text2:'{"text":"Page 1","color":"dark_green"}',Text3:'{"text":"General","color":"white"}',Text4:""}
...
setblock 202 65 -66 dark_oak_wall_sign[facing=south]{GlowingText:true,Color:"blue",Text1:'{"clickEvent":{"action":"run_command","value": "trigger lobbysigns set 1001"},"text": ""}',Text2:'{"text":"Start Game","color":"dark_green"}',Text3:'[{"text":"[","color": "white"},{"keybind":"key.use","color":"white"},{"text":"]","color": "white"}]',Text4:""}
...
setblock 201 64 -66 dark_oak_wall_sign[facing=south]{GlowingText:true,Color:"red",Text1:'{"clickEvent":{"action":"run_command","value": "trigger lobbysigns set 1103"},"text": ""}',Text2:'{"text":"Reset to","color":"white"}',Text3:'{"text":"Default","color":"red"}',Text4:""}
#setblock 202 64 -66 air
setblock 203 64 -66 oak_wall_sign[facing=south]{GlowingText:true,Color:"blue",Text1:'{"clickEvent":{"action":"run_command","value": "trigger lobbysigns set 107"},"text": ""}',Text2:'{"text":"Unlock Settings","color":"yellow"}',Text3:'{"text":"[Admins Only]","color":"white"}',Text4:""}
