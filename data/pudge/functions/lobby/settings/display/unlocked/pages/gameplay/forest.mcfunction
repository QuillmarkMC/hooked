setblock 202 64 -66 oak_wall_sign[facing=south]{GlowingText:true,Text1:'{"clickEvent":{"action":"run_command","value": "trigger lobbysigns set 207"},"text": ""}',Text2:'{"text":"Forest","color":"white"}',Text3:'',Text4:""}
