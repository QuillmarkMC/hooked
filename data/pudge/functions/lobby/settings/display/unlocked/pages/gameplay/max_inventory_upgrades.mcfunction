...
execute if score $MaxInventoryUpgrades gold = $MaxInventoryUpgrades lobbysigns.default run data merge block 205 65 -66 {Text3:'{"score":{"name":"$MaxInventoryUpgrades","objective":"var"},"color":"green"}'}
