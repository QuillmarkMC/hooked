...
execute if score $StartingGold gold = $StartingGold lobbysigns.default run data merge block 199 65 -66 {Text3:'{"score":{"name":"$StartingGold","objective":"shop"},"color":"green"}'}
