...
execute if score $IncomeAmount shop = $IncomeAmount lobbysigns.default run data merge block 202 65 -66 {Text3:'{"score":{"name":"$IncomeAmount","objective":"shop"},"color":"green"}'}
