...
setblock 200 64 -66 oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"white",messages:['{"text":"Strongis13","color":"aqua"}', '{"text":"Programmer","color":"white"}', '{"text":"Game Balance","color":"white"}', '""']}}
...
setblock 204 64 -66 oak_wall_sign[facing=south]{front_text:{has_glowing_text:true,color:"white",messages:['{"text":"Soccby","color":"aqua"}', '{"text":"Builder","color":"white"}', '{"text":"Game Balance","color":"white"}', '""']}}
