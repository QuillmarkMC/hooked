...
setblock 200 64 -66 oak_wall_sign[facing=south]{Text1:'{"text":"Strongis13","color":"blue"}',Text2:'{"text":"Programmer","color":"light_gray"}',Text3:'{"text":"Game Balance","color":"light_gray"}',Text4:''}
