...
setblock 205 65 -66 spruce_wall_sign[facing=south]{GlowingText:true,Color:"blue",Text1:'{"clickEvent":{"action":"run_command","value": "/function pudge:lobby/settings/actions/general/lock"},"text": ""}',Text2:'{"text":"Lock Settings","color":"dark_green"}',Text3:'{"text":"[Admins Only]","color":"white"}',Text4:""}
#3rd row
#setblock 199 64 -66 air
#setblock 200 64 -66 air
#setblock 201 64 -66 air
setblock 202 64 -66 oak_wall_sign[facing=south]{GlowingText:true,Color:"red",Text1:'{"clickEvent":{"action":"run_command","value": "trigger lobbysigns set 103"},"text": ""}',Text2:'{"text":"Reset to","color":"white","bold": true}',Text3:'{"text":"Default","color":"white","bold": true}',Text4:""}
