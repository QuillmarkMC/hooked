...
setblock 202 65 -66 oak_wall_sign[facing=south]{GlowingText:true,Color:"blue",Text1:'{"clickEvent":{"action":"run_command","value": "trigger lobbysigns set 1"},"text": ""}',Text2:'{"text":"Start Game","color":"dark_green"}',Text3:'[{"text":"[","color": "white"},{"keybind":"key.use","color":"white"},{"text":"]","color": "white"}]',Text4:""}
