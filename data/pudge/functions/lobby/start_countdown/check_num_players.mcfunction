...
execute if score $ready_num lobbysigns matches 0 run tellraw @s [{"text":"[!] ","color":"dark_red"},{"text":"At least one team must be populated to start the game!","color":"white"}]
