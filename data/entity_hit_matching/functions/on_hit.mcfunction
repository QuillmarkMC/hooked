...
execute if entity @a[tag=tempAttackerTag,limit=1,advancements={entity_hit_matching:on_hit={hookarrow=true}}] unless score @s hookID matches 0.. run function pudge:game/ability/hook/begin
